...
<Article title="Cvingerska jama" lang="si" ssrLang={props.cookies.lang}>
    ...
    <SketchFab lang="si"/>
    <Subtitle caption="3D model vhodnega dela jame pred jamarsko-arheološkimi raziskavami. Model Tomaž Grdin." />
    ...
    />
    <Subtitle caption="Čiščenje nasutja leta 1987 in 30 let pozneje." />     
...
<Article title="The Cvinger Cave" lang="en" ssrLang={props.cookies.lang}>
    ...
    <SketchFab lang="en"/>
    <Subtitle caption="3D model of the entrance chamber prior to the speleological-archaeological investigations. Model by Tomaž Grdin. " />     
    ...
    />
    <Subtitle caption="Clearing the cave deposits in 1987 and thirty years later. " />     
